...
RSpec.describe Api::V1::TicketsController, type: :routing do
  describe "routing" do
    it "routes to #index" do
      expect(:get => "/api/v1/tickets").to route_to("api/v1/tickets#index")
    end
    ...
    it "routes to #update via PATCH" do
      expect(:patch => "/api/v1/tickets/1").to route_to("api/v1/tickets#update", :id => "1")
    end

    it "routes to #destroy" do
      expect(:delete => "/api/v1/tickets/1").to route_to("api/v1/tickets#destroy", :id => "1")
    end
  end
end
